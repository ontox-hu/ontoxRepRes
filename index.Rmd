...
#### 16:30-18:10 hands-on sharing your current data
 ...
 - machine readable data and workflows
   ...
   + BREAKOUT (5 people, 45 min) 
     + Option 1: *15 min DIY tidy data* (exercise B3) and *20 min version control* (exercise B4 and B5)
     + Option 2: finish C1 till C3, and *20 min visualising workflows* (exercise C4 and C5)
