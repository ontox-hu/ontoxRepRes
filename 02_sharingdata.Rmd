...
**Note: this half of the workshop we will split the participants based on their previous experience and tools they are using.**


## **Exercise A1: ** reflection {.blauw}

5-10 minutes

Go through your e-mail and look for the last time you sent some colleague or colaborator data. Suppose you move to a different university, your mailbox is closed and some stranger needs to use your data for a project. Would they have enough information to do so? What would you do differently?

Discuss in pairs of 2.



## **Exercise A2: ** What can go wrong with data in Excel (groups of 3-5)
