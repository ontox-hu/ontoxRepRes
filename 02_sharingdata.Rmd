...
**Note: this half of the workshop we will split the participants based on their previous experience and tools they are using. If you can answer "yes" to the following questions, you are on the correct page:**
 ...
 - I don't (yet) use code to analyse my data
 - I would like to learn what tidy data is
...
## Some common spreadsheat errors to avoid
...
### **Exercise B3**; Understanding data workflows with Mermaid {.blauw}
...
### **Exercise B4**; Creating your own workflow {.blauw}
