...
Obviously, keeping meta data with your data and not changing raw data file names helps solve the bulk of this problem. There is an issue though: data may change. You may receive an updated dataset. You will also process the data yourself to be able to analyse it. 
