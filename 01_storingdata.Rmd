...
Go through your e-mail and look for the last time you sent some colleague or colaborator data. Suppose you move to a different university, your mailbox is closed and some stranger needs to use your data for a project. They have your e-mail. Would they have enough information to do so?

Discuss in pairs of 2.

## The _GUI problem_

Many people use GUI based software (graphical user interface). Citing Wikipedia, this is a *"user interface that allows users to interact with electronic devices through graphical icons and audio indicator such as primary notation, instead of text-based user interfaces, typed command labels or text navigation."* So basically, any program that you use by clicking around in menu's, or using voice control etc, for data science this could for instance be Excel.
...
This is why so many researchers are using code to analyse their data. Code will automatically show all the steps you performed when doing an analysis. If you use code, just make sure you keep the code with the data. If you don't, make sure you precisely keep track of every step you take, in a separate text document.
...
Look at your research projects. What needs to be done to clean the folder structure? Try to update it right now.
